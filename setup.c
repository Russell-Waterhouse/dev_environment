#include <stdlib>
#include <stdio.h>
/* TODO: link types.h here so I have i32 */
...
void run_command_or_die(char* command) {
    /*Helper function to run shell commands.*/
    i32 status = system(command);
    if (status != 0) {
